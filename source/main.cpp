...
RenderWindow window("Mini-Golf", 640, 480);

SDL_Texture* ballTexture = window.loadTexture("./resource/gfx/ball.png");
SDL_Texture* holeTexture = window.loadTexture("./resource/gfx/hole.png");
SDL_Texture* pointTexture = window.loadTexture("./resource/gfx/point.png");
SDL_Texture* tileDarkTexture32 = window.loadTexture("./resource/gfx/tile32_dark.png");
SDL_Texture* tileDarkTexture64 = window.loadTexture("./resource/gfx/tile64_dark.png");
SDL_Texture* tileLightTexture32 = window.loadTexture("./resource/gfx/tile32_light.png");
SDL_Texture* tileLightTexture64 = window.loadTexture("./resource/gfx/tile64_light.png");
SDL_Texture* ballShadowTexture = window.loadTexture("./resource/gfx/ball_shadow.png");
SDL_Texture* bgTexture = window.loadTexture("./resource/gfx/bg.png");
SDL_Texture* uiBgTexture = window.loadTexture("./resource/gfx/UI_bg.png");
SDL_Texture* levelTextBgTexture = window.loadTexture("./resource/gfx/levelText_bg.png");
SDL_Texture* powerMeterTexture_FG = window.loadTexture("./resource/gfx/powermeter_fg.png");
SDL_Texture* powerMeterTexture_BG = window.loadTexture("./resource/gfx/powermeter_bg.png");
SDL_Texture* powerMeterTexture_overlay = window.loadTexture("./resource/gfx/powermeter_overlay.png");
SDL_Texture* logoTexture = window.loadTexture("./resource/gfx/logo.png");
SDL_Texture* click2start = window.loadTexture("./resource/gfx/click2start.png");
SDL_Texture* endscreenOverlayTexture = window.loadTexture("./resource/gfx/end.png");
SDL_Texture* splashBgTexture = window.loadTexture("./resource/gfx/splashbg.png");

Mix_Chunk* chargeSfx = Mix_LoadWAV("./resource/sfx/charge.mp3");
Mix_Chunk* swingSfx = Mix_LoadWAV("./resource/sfx/swing.mp3");
Mix_Chunk* holeSfx = Mix_LoadWAV("./resource/sfx/hole.mp3");


SDL_Color white = { 255, 255, 255 };
SDL_Color black = { 0, 0, 0 };
TTF_Font* font32 = TTF_OpenFont("./resource/font/font.ttf", 32);
TTF_Font* font48 = TTF_OpenFont("./resource/font/font.ttf", 48);
TTF_Font* font24 = TTF_OpenFont("./resource/font/font.ttf", 24);
...
{
	int biggestStroke = std::max(balls[0].getStrokes(), balls[1].getStrokes());
	return "STROKES: " + std::to_string(biggestStroke);
}
...
std::string getLevelText(int side)
{
	...
	return "HOLE: " + std::to_string(tempLevel);
}
void update()
{
...
void graphics()
{
	...
	if (state != 2)
	{
		...
		window.renderCenter(0, -240 + 16 + 3, getStrokeText().c_str(), font24, black);
		window.renderCenter(0, -240 + 16, getStrokeText().c_str(), font24, white);
	}
	else
	{
		...
		window.renderCenter(0, 3 + 32, getStrokeText().c_str(), font32, black);
		window.renderCenter(0, 32, getStrokeText().c_str(), font32, white);
	}
	window.display();
}
...
void titleScreen()
{
	if (SDL_GetTicks() < 2000)
	{
		...
		window.renderCenter(0, 0 + 3, "MQUAN K68G-AT", font32, black);
		window.renderCenter(0, 0, "MQUAN K68G-AT", font32, white);
		window.display();
	}
	else
	{
